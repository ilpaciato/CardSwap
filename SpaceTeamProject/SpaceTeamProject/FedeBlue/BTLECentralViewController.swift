    ...
    */
    func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor characteristic: CBCharacteristic, error: Error?) {
        ...
        if stringFromData.isEqual(to: "EOM") {
            ...
            var ab = String(data: data.copy() as! Data, encoding: String.Encoding.utf8)
            var a: NSData = ab!.data(using: String.Encoding.utf8)! as NSData
           
            let myStruct = try! JSONDecoder().decode(SpacePerson.self, from: a as Data) 
